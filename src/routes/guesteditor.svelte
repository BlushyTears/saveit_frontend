<script>
    ...
    function notifyUser() {
        showFailedNotification("Please register to save");
    }
  ...
  <div class="header-body">
    ...
    <div class="parrent-body">
      <div class="body">
        ...
        <p style="margin-left: 1rem; background-color: gray; padding: 0.1rem; width: 89.5%; margin: 0 auto;">Please note that this is just a sandbox editor, and none of this will actually be saved. Please register (it's Free) if you want to actually save your amazing content.</p>
