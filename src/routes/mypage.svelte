...
<main>
    <div class="button-component">
        <img class="profile-img" src={ProfileImg} alt="Unable to load profile image">
        <h1 style="font-size: 1.5em;">Ellie's coffee n sweets paradise</h1>
 
        <!-- gotta use a loop to automate this later -->
        <button class="recipe-link" style="background-image: url({cookieImage});" on:click={() => openModal(0)}>
            <span class="emoji">🍪</span>
            <h2 class="modal-btn-text">Chocolate Chip Cookies</h2>
            </button>
        
            <button class="recipe-link" style="background-image: url({coffeeImage});" on:click={() => openModal(1)}>
            <span class="emoji">☕</span>
    ...
    <div class="template-container">
        ...
        <ol>
            ...
            <br>
            <li>In a mixing bowl, combine the logic-inspired flour, procedural provisions sugar, and the pinch of statistical mode salt. Mix them well together to ensure an even distribution.</li>
            <br>
            <li>Cream the structural substance butter in a separate large bowl using an electric mixer until it becomes light and fluffy.</li>
            <br>
            <li>Add the musical mode vanilla extract to the butter and continue mixing until fully incorporated.</li>
            <br>
            <li>Gradually beat in the large grammatical eggs, one at a time, ensuring each egg is well combined before adding the next.</li>
            <br>
            <li>Slowly add the dry ingredients from the first mixing bowl to the wet ingredients in the large bowl. Mix them together until you have a smooth and coherent cookie dough.</li>
            <br>
            <li>Take small portions of the dough and shape them into cookies. You can use your hands to form round shapes or use cookie cutters for more structured modal cookies.</li>
            <br>
            <li>Place the cookies on the prepared baking sheet, leaving some space between each cookie.</li>
            <br>
            <li>Bake the cookies in the preheated oven for approximately 10-12 minutes or until the edges turn golden brown.</li>
            <br>
            <li>Once baked, remove the cookies from the oven and let them cool on a wire rack.</li>
        </ol>
    ...
    <div class="template-container">
        ...
        <h2>Instructions:</h2>
        <ol>
            <li>Brew a cup of strong coffee and let it cool in the refrigerator until chilled.</li>
            <br>
            <li>In a blender, combine the chilled coffee, milk, salted caramel sauce, granulated sugar, and vanilla extract.</li>
            <br>
            <li>Blend the mixture until it becomes smooth and well-combined.</li>
            <br>
            <li>Fill a glass with ice cubes to your preference.</li>
            <br>
            <li>Pour the blended salted caramel coffee mixture over the ice cubes.</li>
            <br>
            <li>If desired, top the latte with whipped cream for an extra indulgent treat.</li>
            <br>
            <li>For a finishing touch, drizzle some additional salted caramel sauce over the whipped cream.</li>
        </ol>
        
        <br>
        <p>Your delightful Salted Caramel Iced Latte is now ready to be enjoyed! Sip and savor the perfect balance of sweet and salty flavors in this refreshing coffee beverage.</p>
...
<style>
    ...
    main {
        ...
        background: linear-gradient(90deg, rgba(255,239,207,1) 8%, rgba(255,234,180,1) 33%, rgba(255,215,147,1) 54%, rgba(255,205,103,1) 74%);
        min-height: 90rem;
        overflow-y: hidden;
    }
